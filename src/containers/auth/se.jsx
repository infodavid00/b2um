...
export default function Se() {
  return (
      <div style={{width:'100%', marginTop:'-5%'}}>
       <p className='auth-continuewith'>
       <span className='acw-l'><img src={fb} width={60}  /></span>
       <span className='acw-t'>Continue with Facebook</span>
       <span className='acw-l'> </span>
       </p> 
       <p className='auth-continuewith'>
        <span className='acw-l'><img src={google} width={40} /></span>
       <span className='acw-t'>Continue with Google</span>
       <span className='acw-l'> </span>
       </p> 
       <p className='auth-continuewith'>
       <span className='acw-l'><img src={x} width={23} /></span>
       <span className='acw-t'>Continue with Twitter</span>
       <span className='acw-l'> </span>
       </p> 
       <p className='auth-continuewith'>
        <span className='acw-l'><img src={paypal} width={27} /></span>
